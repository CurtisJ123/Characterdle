...
- **Episode Ladder (feature branch):** five daily difficulties from Easy to Impossible, each with five events, four attempts, locked correct positions, saved progress, and spoiler-free sharing. See the [mode guide](docs/EPISODE_LADDER.md); its current event catalog is test content.
...
- **Random practice:** Premium members can generate unlimited temporary character, quote, and Episode Ladder (feature branch) rounds directly from source content without affecting daily stats, streaks, archives, or analytics.
